...
class ImpersonateManagerTest extends TestCase
{
    ...
    public function it_can_take_impersonating()
    {
        ...
        $this->assertEquals(2, $this->app['auth']->user()->getAuthIdentifier());
        $this->assertEquals(1, $this->manager->getImpersonatorId());
    ...
    public function it_can_take_impersonating_other_guard()
    {
        ...
        $this->assertEquals(3, $this->app['auth']->user()->getAuthIdentifier());
        $this->assertEquals(1, $this->manager->getImpersonatorId());
    ...
    {
        # Login generic OtherAdmin (ID=1)
        $this->app['auth']->guard($this->thirdGuard)->loginUsingId(1);
